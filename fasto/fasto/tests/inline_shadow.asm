...
# 	mv	_let_c_29_,_let_c_21_
	mv	x12, x13
# was:	mv	_let_d_30_, _let_b_28_
	li	x11, 1000
# was:	li	_times_L_37_, 1000
# 	mv	_times_R_38_,_let_d_30_
	mul	x11, x11, x12
# was:	mul	_plus_L_35_, _times_L_37_, _times_R_38_
	li	x12, 100
# was:	li	_times_L_39_, 100
	mv	x14, x13
# was:	mv	_times_R_40_, _let_a_27_
	mul	x12, x12, x14
# was:	mul	_plus_R_36_, _times_L_39_, _times_R_40_
	add	x11, x11, x12
# was:	add	_plus_L_33_, _plus_L_35_, _plus_R_36_
	li	x12, 10
# was:	li	_times_L_41_, 10
# 	mv	_times_R_42_,_let_c_29_
	mul	x10, x12, x10
# was:	mul	_plus_R_34_, _times_L_41_, _times_R_42_
	add	x10, x11, x10
# was:	add	_plus_L_31_, _plus_L_33_, _plus_R_34_
