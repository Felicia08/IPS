...
l.safe_7_:
	li	x12, 100
# was:	li	_a_exp_8_, 100
	mv	x10, x3
# was:	mv	_let_fs_5_, x3
	slli	x13, x11, 2
# was:	slli	_tmp_13_, _size_6_, 2
	addi	x13, x13, 4
...
# was:	sw	_size_6_, 0(_let_fs_5_)
	addi	x13, x10, 4
# was:	addi	_addr_9_, _let_fs_5_, 4
	mv	x14, x0
# was:	mv	_i_10_, x0
l.loop_beg_11_:
	bge	x14, x11, l.loop_end_12_
# was:	bge	_i_10_, _size_6_, l.loop_end_12_
	sw	x12, 0(x13)
# was:	sw	_a_exp_8_, 0(_addr_9_)
	addi	x13, x13, 4
# was:	addi	_addr_9_, _addr_9_, 4
	addi	x14, x14, 1
