...
# was:	beq	_cond_L_5_, x0, l.false_7_
	jal	f.no_way
# was:	jal	f.no_way, 
# 	mv	_cond_R_6_,x10
	beq	x10, x0, l.false_7_
# was:	beq	_cond_R_6_, x0, l.false_7_
	li	x11, 1
# was:	li	_tmp_4_, 1
	j	l.end_8_
l.false_7_:
...
# was:	jal	p.putstring, x10
	li	x10, 1
# was:	li	_cond_L_12_, 1
	bne	x10, x0, l.true_14_
# was:	bne	_cond_L_12_, x0, l.true_14_
	jal	f.no_way
# was:	jal	f.no_way, 
# 	mv	_cond_R_13_,x10
	bne	x10, x0, l.true_14_
# was:	bne	_cond_R_13_, x0, l.true_14_
	li	x11, 0
# was:	li	_tmp_11_, 0
	j	l.end_15_
l.true_14_:
